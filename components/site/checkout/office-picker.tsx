...
export function OfficePicker({
  ...
  if (available.length === 0) {
    return (
      <div className="rounded-md border border-border-soft bg-kraft-soft px-4 py-3">
        ...
        <button
          ...
          className="mt-2 rounded-sm font-sans text-sm font-semibold text-charcoal underline decoration-salmon-ink decoration-2 underline-offset-4"
        >
  ...
  if (selected && !expanded) {
    return (
      <div className="flex items-start gap-3 rounded-md border border-border-soft-strong bg-kraft-soft p-4 shadow-soft">
        <Icon className="mt-0.5 h-5 w-5 shrink-0 text-salmon-ink" aria-hidden="true" />
        ...
        <button
          ...
          className="ml-auto shrink-0 rounded-sm px-1 py-0.5 font-sans text-sm font-semibold text-charcoal underline decoration-salmon-ink decoration-2 underline-offset-4 hover:text-charcoal-soft"
        >
          Промени
        </button>
      </div>
        ...
        {shown.map((office) => (
          <div key={office.code}>
            ...
            <label
              ...
              className="flex cursor-pointer items-start gap-3 rounded-md border border-border-soft bg-cream p-3 transition-colors duration-150 hover:border-border-soft-strong peer-checked:border-border-soft-strong peer-checked:bg-kraft-soft peer-checked:shadow-soft peer-checked:[&>svg]:text-salmon-ink peer-focus-visible:outline peer-focus-visible:outline-2 peer-focus-visible:outline-offset-2 peer-focus-visible:outline-salmon-ink"
            >
              <Icon
