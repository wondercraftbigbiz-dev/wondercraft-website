...
export function CtaButton({
  ...
  return (
    <button
      ...
      onClick={() => open(model)}
      className={cn(
        'inline-flex min-h-11 items-center justify-center gap-2 rounded-md px-6 py-3 font-sans text-base font-semibold transition-all duration-200 ease-[cubic-bezier(0.34,1.56,0.64,1)] hover:-translate-y-0.5 hover:scale-[1.02] active:translate-y-0 active:scale-[0.98]',
        variant === 'solid' &&
